...
```
	flutter-auto --j=/usr/share/flutter/default.json --b=/usr/share/flutter/gallery --f
```
...
```
	flutter-auto --j=/usr/share/flutter/default.json --b=/usr/share/flutter/gallery --f --observatory-host=0.0.0.0 --observatory-port=1234
```
